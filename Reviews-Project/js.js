...
const reviews = [
  ...
  let personTitle = document.getElementById("title")
  let personDescription = document.getElementById("desc")
  ...
  let randomPerson = document.getElementById("suprise")
  ...
  function PersonNow(){
    personImage.src = reviews[counter].img
    personName.textContent= reviews[counter].name
    personTitle.textContent= reviews[counter].job
    personDescription.textContent= reviews[counter].text
  }